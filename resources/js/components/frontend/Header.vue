		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
					<!-- ============================================================= LOGO ============================================================= -->
<div class="logo">
	<router-link to="/" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown"><img src="images/logo.png" alt=""></router-link>
...
export default {
  ...
  mounted() {
    this.$store.dispatch("activeTopCategories");
  },
  watch:{
  ...
  computed:{
    categories(){
      return this.$store.getters.getActiveTopCategories;
    }
  },
